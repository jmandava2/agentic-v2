...
export default function HealthCheckPage() {
  ...
  const handleUpload = () => {
    ...
    setTimeout(() => {
        ...
        toast({
            ...
            description: 'The crop appears to be healthy. No major issues detected.',
        });
    }, 1500);
  }
  ...
  return (
    <Card className="max-w-2xl mx-auto">
      <CardHeader>
        <CardTitle className="font-headline">Crop Health Check-in</CardTitle>
        <CardDescription>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <Label htmlFor="camera-input" className="w-full">
              <Button asChild className="w-full" variant="outline">
                <span><Camera className="mr-2 h-4 w-4" /> Capture with Camera</span>
              </Button>
              <Input
                type="file"
                id="camera-input"
